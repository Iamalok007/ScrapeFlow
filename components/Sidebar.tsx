...
import { Home as HomeIcon, Layers as Layers2Icon, ShieldCheck, Coins, MenuIcon } from 'lucide-react'
  ...
  return <div className='block border-separate bg-background md:hidden'>
    <div className='container flex items-center justify-between px-8'>
      <Sheet open={isOpen} onOpenChange={setOpen}>
        ...
        <SheetContent className='w-[400px] sm:w-[450px] space-y-4' side={"left"}>
          <Logo/>
